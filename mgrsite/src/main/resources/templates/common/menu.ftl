<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		<a href="#" data-toggle="collapse" data-target="#expBidRequest">
			<span>体验标相关</span>
		</a>
		<ul class="in" id="expBidRequest">
			<li class="expBidRequestPublish"><a href="/expBidRequestPublishPage">发布体验标</a></li>
			<li class="expBidRequestList"><a href="/expBidRequest_list">体验标管理</a></li>
			<li class="expBidRequestReturnList"><a href="/expBidRequestReturn_list">体验标结算</a></li>
		</ul>
	</li>
	<li class="list-group-item">
