...
public class BidConst {
    ...
    public final static int ACCOUNT_ACTIONTYPE_CALLBACK_INTEREST_MONEY = 12;// 资金流水类别：利息回款
    // 标审核失败
    // 冻结金额减少
    // 可用余额增加
    ...
    public final static int SYSTEM_ACCOUNT_ACTIONTYPE_PAY_INTEREST = 4;// 系统账户支付体验标利息
    ...
    短信的有效时间:单位分钟
     */
    public static final int MESSAGER_VAILD_TIME = 5;
    /*
    短信发送的间隔时间:单位秒
     */
    public static final int MESSAGE_INTERVAL_TIME = 90;
    /*
    邮件的有效时间:单位天
     */
    ...
    注册发放体验金+注册方法体验金流水类型
     */
    public static final int EXPMONEY_TYPE_REGISTER = 1;
    /*
    体验金投标流水
     */
    public static final int EXPMONEY_FLOW_BID = 2;
    /*
    体验标投标失败流水
     */
    public static final int EXPMONEY_FLOW_BID_FAILED = 3;
    /*
    体验标投标成功流水
     */
    public static final int EXPMONEY_FLOW_BID_SUCCESS = 4;
    /*
    体验标结算退回体验金本金
     */
    public static final int EXPMONEY_FLOW_RETURN_SUCCESS = 5;
}
